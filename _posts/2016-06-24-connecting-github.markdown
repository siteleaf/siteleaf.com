...
If you are new to Jekyll, you may want to start with our [Jekyll from Scratch](/blog/jekyll-from-scratch-copy/) tutorial to catch up on the basics first.
...
If for any reason it wasn’t successful, there would be an red error message here to explain what happened.

You can also see the status of publishes and previews here, which we'll get into later.
...
Siteleaf has a special collection called Uploads (found under **Files > Uploads**), which is where we can put image uploads and any non-theme related assets content editors might need to access. In GitHub, this will show up as a directory called `_uploads`.
...
This will open a unique URL where you can preview your entire site. This URL can be also be shared with clients or co-workers to quickly show development progress or get feedback on unpublished content.

When previewing your site, Siteleaf will automatically show future-dated and draft posts. These generally will not be published live, unless enabled in your [site configuration](https://jekyllrb.com/docs/configuration/). 
{: .warning}

## Publishing your site

Siteleaf lets you publish just about anywhere: GitHub Pages, Amazon S3, Rackspace Cloud Files, and FTP or SFTP servers like MediaTemple, Dreamhost, Digital Ocean, and so on.

For this demo, I’ll choose GitHub Pages, which we love and recommend. It’s backed by a CDN and included free with your GitHub account. 
...
Once its done, visit your domain name and check out your new site! As a shortcut, you can also jump to your live site from within the status menu.

## Next steps

To dive deeper, check out our help site [learn.siteleaf.com](http://learn.siteleaf.com).

Stay tuned for a future tutorial where we’ll further explore Siteleaf and how to customize the admin for your site.